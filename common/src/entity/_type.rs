...
pub enum EntityType {
    ...
    #[size(length = 15.7, width = 11)]
    #[props(speed = 500, range = 2800000, stealth = 0.50)]
    ...
    #[info(
        label = "Yak-38",
        link = "https://en.wikipedia.org/wiki/Yakolev_Yak-38"
    )]
    #[entity(Aircraft, Plane, level = 7)]
    #[size(length = 16.37, width = 7.32)]
    #[props(speed = 380, range = 1300000)]
    #[sensors(visual)]
    #[armament(Kh23)]
    #[armament(Kh23)]
    #[armament(R60)]
    ...
    #[info( 
        label = "ASEV",
        link = "https://en.wikipedia.org/wiki/Aegis_system_equipped_vessel_(ASEV)"
    )]
    #[entity(Boat, Destroyer, level = 10)]
    #[size(length = 190, width = 25, draft = 8.4)]
    #[props(speed = 15.95, stealth = 0.5)]
    #[sensors(radar, sonar, visual)]
    #[armament(Type12, forward = 50, side = 2, count = 4, symmetrical, vertical)]
    #[armament(Type12, forward = -58, side = 2, count = 4, symmetrical, vertical)]
    #[armament(Type07, forward = 46, side = 2, count = 1, symmetrical, vertical)]
    #[armament(Type07, forward = 46, vertical)]
    #[armament(Type07, forward = -54, side = 2, count = 1, symmetrical, vertical)]
    #[armament(Type07, forward = -54, vertical)]
    #[armament(SM3, forward = 42, side = 2, count = 2, symmetrical, vertical)]
    #[armament(SM3, forward = -52, side = 2, count = 2, symmetrical, vertical)]
    #[armament(Seahawk, forward = -86.3, external)]
    #[turret(Mark12, forward = 60, fast, azimuth_b = 20)]
    ASEV,
    #[info(
        label = "Astute",
    ...
    #[exhaust(forward = -1)]
    Bismarck,
    #[info(label = "Boss Ship")]
    #[entity(Boat, Battleship, level = 10)]
    #[size(length = 320, width = 70, draft = 12, mast = 38.9)]
    #[props(speed = 20.58)]
    #[sensors(radar, sonar, visual)]
    #[armament(P700, forward = -64.7, side = 6.4, angle = 10, count = 3, symmetrical, hidden)]
    #[armament(S300, forward = -112, side = 10, count = 2, symmetrical, vertical)]
    #[armament(Seahawk, forward = -132.8, external)]
    #[turret(Mark7, forward = 33.51, slow, azimuth_b = 20)]
    #[turret(Mark7, forward = 9.3, side = 18.52, slow, symmetrical, azimuth_br = 40)]
    #[turret(Mark7, forward = -14, side = 18.52, slow, symmetrical, azimuth_br = 40)]
    #[turret(Mark7, forward = -71, side = 25, slow, symmetrical, angle = 180, azimuth_bl = 40)]
    BossShip,
    #[info(
        label = "Buyan",
    ...
    #[info(
        label = "Choe Hyon",
        link = "https://en.wikipedia.org/wiki/Choe_Hyon-class_destroyer"
    )]
    #[entity(Boat, Destroyer, level = 9)]
    #[size(length = 145, width = 16, draft = 9)]
    #[props(speed = 15.43, stealth = 0.5)]
    #[sensors(radar, sonar, visual)]
    #[armament(P700, forward = -40, side = 1.9, count = 2, symmetrical, vertical)]
    #[armament(P700, forward = -45, side = 1.9, count = 2, symmetrical, vertical)]
    #[armament(S300, forward = -30.3, side = 4, count = 2, symmetrical, vertical)]
    #[armament(S300, forward = 26, side = 3.4, count = 2, symmetrical, vertical)]
    #[armament(Harpoon, forward = -10, side = 2.13, count = 2, angle = 90, symmetrical)]
    #[armament(Harpoon, forward = -8, side = 2.13, count = 2, angle = 90, symmetrical)]
    #[armament(Set65, forward = 9, side = 7, count = 2, angle = 90, symmetrical, hidden)]
    #[armament(Ka25, forward = -60, external)]
    #[turret(A190, forward = 40.8, medium, azimuth_b = 20)]
    ChoeHyon,
    #[info(
        label = "Clemenceau",
    ...
    #[info( 
        label = "FDI Frigate", 
        link = "https://en.wikipedia.org/wiki/Defence_and_intervention_frigate"
    )]
    #[entity(Boat, Destroyer, level = 5)]
    #[size(length = 122, width = 17.7, draft = 6.4)]
    #[props(speed = 13.9, stealth = 0.75)]
    #[sensors(radar, sonar, visual)]
    #[armament(MU90, forward = -18.9, side = 5.8, count = 2, angle = 90, symmetrical, hidden)]
    #[armament(Aster30, forward = 33.6, side = 1.2278, count = 2, symmetrical, vertical)]
    #[armament(Exocet, forward = 7.2793, side = -2.368, count = 2, angle = -90, external)]
    #[armament(Exocet, forward = 6.0515, side = -2.368, count = 2, angle = -90, external)]
    #[armament(Exocet, forward = 1.666, side = 2.368, count = 2, angle = 90, external)]
    #[armament(Exocet, forward = 2.8938, side = 2.368, count = 2, angle = 90, external)]
    #[armament(Seahawk, forward = -50.5, external)]
    #[turret(OtoMelara76Mm, forward = 44.2, fast, azimuth_b = 20)]
    #[exhaust(forward = -5.35)]
    FDI,
    #[info(
        label = "Fletcher",
    ...
    #[info(
        label = "Kiev", 
        link = "https://en.wikipedia.org/wiki/Kiev-class_aricraft_carrier"
    )]
    #[entity(Boat, Carrier, level = 10)]
    #[size(length = 273, width = 51.9, draft = 9.42, mast = 42)]
    #[props(speed = 16.463)]
    #[sensors(radar, sonar, visual)]
    #[armament(Yak38, forward = 1.7, side = 15.3, angle = 4.7, external)]
    #[armament(Yak38, forward = -23, side = 13.6, angle = 4.7, external)]
    #[armament(Yak38, forward = -48, side = 11.8, angle = 4.7, external)]
    #[armament(Yak38, forward = -72.3, side = 9.5, angle = 4.7, external)]
    #[armament(Ka25, forward = -96, side = 6.76, angle = 4.7, external)]
    #[armament(Ka25, forward = -120, side = 5.2, angle = 4.7, external)]
    #[armament(P500, forward = 84.6, side = -5.0, angle = 0, count = 2, hidden)]
    #[armament(P500, forward = 84.6, side = -3.46, angle = 0, count = 2, hidden)]
    #[armament(P500, forward = 84.6, side = -1.0, angle = 0, count = 2, hidden)]
    #[armament(P500, forward = 84.6, side = 1.3, angle = 0, count = 2, hidden)]
    #[armament(S300, forward = 99.8, side = -2.5, count = 3, vertical)]
    #[armament(S300, forward = 99.8, side = -7.4, count = 3, vertical)]
    #[armament(Set65, forward = -32, side = -21, count = 5, angle = -90, hidden)]
    #[armament(Set65, forward = -32, side = 21, count = 5, angle = 90, hidden)]
    #[turret(Ak130, forward = 52.8, side = -14.0, angle = 0, medium, azimuth_b = 30)]
    #[turret(Ak130, forward = 65.7, side = -11.3, angle = 0, medium, azimuth_b = 20)]
    Kiev,
    #[info(
        label = "Kirov",
    ...
    #[info(
        label = "Libelle",
        link = "https://en.wikipedia.org/wiki/Libelle-class_torpedo_boat"
    )]
    #[entity(Boat, Mtb, level = 2)]
    #[size(length = 19, width = 4.42, draft = 1.74)]
    #[props(speed = 24.7)]
    #[sensors(radar, visual)]
    #[armament(Set65, forward = -7, side = 1.558, angle = 4, symmetrical, external)]
    #[armament(Wz0839, forward = -2.27, side = 1.656, symmetrical, hidden)]
    #[turret(_2M3M, forward = -8.64, angle = 180, fast)]
    Libelle,
    #[info(
        label = "Lublin",
    ...
    #[info(
        label = "Nimitz",
        link = "https://en.wikipedia.org/wiki/Nimitz-class_aircraft_carrier"
    )]
    #[entity(Boat, Carrier, level = 10)]
    #[size(length = 332.8, width = 76.8, draft = 11.3, mast = 60)]
    #[props(speed = 16.2)]
    #[sensors(radar, visual)]
    #[armament(F35, forward = 49.6, side = -20.8, angle = -5.2, count = 3, external)]
    #[armament(F35, forward = 45.6, side = 3.7, angle = 2, count = 3, external)]
    #[armament(F35, forward = -42.697, side = 17.39, angle = -5.5, external)]
    #[armament(F35, forward = -64.3, side = 29.5, angle = 0, external)]
    #[armament(Seahawk, forward = -107.8, side = 27.67, external)]
    #[armament(Seahawk, forward = -97.8, side = -30.6, external)]
    #[armament(Seahawk, forward = -21.3, side = -30.6, external)]
    #[turret(Mark49Nim, forward = -153.9, side = -28.7, angle = 180, fast)]
    #[turret(Mark49Nim, forward = 102.5, side = 20.8, angle = 0, fast)]
    Nimitz,
    #[info(
        label = "Oberon",
    ...
    #[props(speed = 25.72, stealth = 0.50)]
    #[sensors(radar, visual)]
    ...
    #[size(length = 3.02, width = 2.00547)]
    #[offset(forward = 0.15)]
    #[armament(Rim116, angle = 0, count = 6, hidden)]
    Mark49Nim,
    #[info(
        label = "Mark 51",
    ...
    #[sensors(sonar)]
    _82R,
    #[info(label = "Aim-9", link = "https://en.wikipedia.org/wiki/AIM-9_Sidewinder")]
    #[entity(Weapon, Sam, level = 5)]
    #[size(length = 3, width = 0.28)]
    #[props(speed = 857, range = 18000)]
    #[sensors(radar)]
    Aim9,
    ...
    #[armament(Mark54)]
    Asroc,
    #[info(label = "Aster 30", link = "https://en.wikipedia.org/wiki/Aster_(missile_family)")]
    #[entity(Weapon, Sam, level = 4)]
    #[size(length = 4.9, width = 0.79)]
    #[props(speed = 1543.5, range = 150000)]
    #[sensors(radar)]
    Aster30,
    ...
    #[sensors(radar)]
    Kalibr,
    #[info(label = "Kh-23", link = "https://en.wikipedia.org/wiki/Kh-23_Grom")]
    #[entity(Weapon, Missile, level = 5)]
    #[size(length = 3.5, width = 0.785)]
    #[props(speed = 694, range = 10000)]
    #[sensors(radar)]
    Kh23,
    #[info(label = "LRLAP")]
    #[entity(Weapon, Shell)]
    ...
    Lrlap,
    #[info(label = "LRASM", link = "https://en.wikipedia.org/wiki/AGM-158C_LRASM")]
    #[entity(Weapon, Missile, level = 5)]
    #[size(length = 4.26, width = 0.635)]
    #[props(speed = 308, stealth = 0.75, range = 930000)]
    #[sensors(radar)]
    Lrasm,
    ...
    #[info(
        label = "MU90 Impact",
        link = "https://en.wikipedia.org/wiki/MU90_Impact"
    )]
    #[entity(Weapon, Torpedo, level = 4)]
    #[size(length = 2.85, width = 0.323)]
    #[props(speed = 25.72, range = 10000)]
    #[sensors(sonar)]
    MU90,
    #[info(
    ...
    #[info(
        label = "P-500 Bazalt",
        link = "https://en.wikipedia.org/wiki/P-500_Bazalt"
    )]
    #[entity(Weapon, Missile, level = 4)]
    #[size(length = 11.4, width = 2.6)]
    #[props(speed = 857.5, range = 550000)]
    #[sensors(radar)]
    P500,
    #[info(
        label = "P-700 Granit",
    ...
    #[sensors(radar)]
    P700,
    #[info(label = "R-60", link = "https://en.wikipedia.org/wiki/R-60_(missile)")]
    #[entity(Weapon, Sam, level = 5)]
    #[size(length = 2.1, width = 0.39)]
    #[props(speed = 847, range = 8000)]
    #[sensors(radar)]
    R60,
    ...
    #[sensors(sonar)]
    Set65,
    #[info(label = "SM-3", link = "kttps://en.wikipedia.org/wiki/RIM-161_Standard_Missile_3")]
    #[entity(Weapon, Sam, level = 5)]
    #[size(length = 6.55, width = 1.57)]
    #[props(speed = 1543, range = 1200000)]
    #[sensors(radar)]
    SM3,
    ...
    #[sensors(sonar)]
    Torped45,
    #[info(label = "Type 07", link = "https://en.wikipedia.org/wiki/Type_07_vertical-launch_anti-submarine_rocket")]
    #[entity(Weapon, RocketTorpedo, level = 5)]
    #[size(length = 6.535, width = 0.80)]
    #[props(speed = 343, range = 30000, damage = 0)]
    #[armament(Mark54)]
    Type07,
    #[info(label = "Type 12", link = "https://en.wikipedia.org/wiki/Type_12_surface-to-ship_missile")]
    #[entity(Weapon, Missile, level = 5)]
    #[size(length = 5, width = 1)]
    #[props(speed = 309, range = 400000)]
    #[sensors(radar)]
    Type12,
    #[info(
        label = "Type 53",
